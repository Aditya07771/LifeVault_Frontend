...
export const storyAPI = {
    ...
    addRecipient: (id: string, data: any) => api.post(`/stories/${id}/recipients`, data),

    addChapter: (storyId: string, data: any) => api.post(`/stories/${storyId}/chapters`, data),

    unlockChapter: (
        storyId: string,
        chapterNumber: number,
        data?: { latitude?: number; longitude?: number; qrCode?: string; password?: string }
    ) => api.post(`/stories/${storyId}/chapters/${chapterNumber}/unlock`, data || {}),
};
